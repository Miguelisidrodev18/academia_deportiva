...
export default function DisciplinasEdit({ disciplina }: Props) {
    ...
    return (
        <AppLayout title="Editar Disciplina">
            <div className="max-w-lg mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-secondary mt-2">Editar Disciplina</h1>
                </div>
